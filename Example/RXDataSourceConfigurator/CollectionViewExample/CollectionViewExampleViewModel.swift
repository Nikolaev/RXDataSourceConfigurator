//
//  CollectionViewExampleViewModel.swift
//  Example
//
...
protocol CollectionViewExampleViewModelProtocol {
    var bindings: CollectionViewExampleViewModel.Bindings { get }
    var commands: CollectionViewExampleViewModel.Commands { get }
}
...
class CollectionViewExampleViewModel: CollectionViewExampleModuleProtocol, CollectionViewExampleViewModelProtocol {
...
private extension CollectionViewExampleViewModel {
...
private extension CollectionViewExampleViewModel {
    ...
    func fetchItems() {
        let models = (0...20).map { index -> ItemModel in
            .init(id: "\(index)",
                  title: "Title \(index)",
...
private extension CollectionViewExampleViewModel {
    ...
    func fetchCounters() {
        let counters = (0...10).map { index -> CounterModel in
